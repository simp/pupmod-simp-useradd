...
class useradd::sysconfig_init (
  ...
  Useradd::AnsiColors  $setcolor_success  = 'green',
  Useradd::AnsiColors  $setcolor_failure  = 'red',
  Useradd::AnsiColors  $setcolor_warning  = 'yellow',
  Useradd::AnsiColors  $setcolor_normal   = 'default',
